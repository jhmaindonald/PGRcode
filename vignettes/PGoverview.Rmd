...
This new text, which should appear in the first quarter of 2024, is a
...
for publication have been a major contributor to over-estimation, on
average, of effect sizes by a factor that may be 2.0 or more.  A case is
made for the publication in some form of all studies that meet minimum
design and execution standards. A stricter criterion than $p \leq 0.05$,
perhaps designing for $p \leq 0.005$ is called for when experiments are
planned.
