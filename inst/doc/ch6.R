...
## ----6_1, w=5, h=1.8, ps=10, mgp=c(2.25,0.5,0), echo=FALSE----------------------------
...
## ----6_2A, w=5.5, h=1.95, lwd=0.5, mgp=c(2,1,0), tcl=-0.25, ps=9, left=1, bot=1, top=2.5,echo=FALSE, out.width="100%"----
#  par(oma=c(0,0,1.5,0))
#  par(pty="s")
...
## ----6_2B, w=5.5, h=2.25, mgp=c(2.25,0.5,0), echo=FALSE, out.width="100%"-------------
#  library(lattice)
...
## ----F1_5a, message=FALSE, warning=FALSE----------------------------------------------
...
## ----F1_5c, message=FALSE, warning=FALSE----------------------------------------------
#  auto.arima(LakeHuron)

## ----F1_5d, message=FALSE, warning=FALSE----------------------------------------------
#  (aaLH0 <- auto.arima(LakeHuron, d=0, approximation=F, stepwise=F))

## ----6_4, w=4.0, h=2.4, mgp=c(2,0.5,0), tcl=-0.25, ps=10, top=2.5,echo=FALSE, out.width="48%"----
...
## ----F1_5g, message=FALSE, warning=FALSE----------------------------------------------
#  auto.arima(LakeHuron, d=0, max.Q=0, approximation=F, stepwise=F)

## ----6_5, w=4.25, h=2.1, echo=FALSE, out.width='100%'---------------------------------
...
## ----6_6, w=4, h=2.4, bot=1, left=-1, top=2, ps=9, mgp=c(1.75,0.5,0), echo=FALSE, warning=FALSE, fig.show="hold", out.width="48%"----
...
## ----6_7, echo=FALSE, w=7.5, h=2.25, ps=9, las=0, out.width="100%"--------------------
...
## ----6_8, w=2.75, h=2.5, bot=0.5, left=-1.5, top=0.5, ps=9, cex.lab=0.9, mgp=c(1.75,0.5,0), echo=FALSE, out.width="32%"----
...
## ----6_9, w=6.5, h=2.65, bot=0.5, left=-1.5, top=0.5, cex.lab=0.9, ps=9, mgp=c(2.0,0.5,0), mfrow=c(1,2), echo=FALSE, out.width="100%"----
#  plot(mdbAVt1.gam, residuals=T, cex=2, fg="gray")

## ----6_10, w=6, h=2.5, bot=0.5, left=-1, top=0.5, cex.lab=0.9, mgp=c(1.75,0.5,0), echo=FALSE, out.width="100%"----
...
## ----6_12, w=6, h=2.75, bot=0.5, top=1.5, las=0, xpd=TRUE, tcl=-0.3, cex.lab=0.9, echo=FALSE, ps=10, mfrow=c(1,2), out.width="100%"----
