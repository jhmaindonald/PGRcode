...
Here are recorded steps that can be followed when a vignette 
is changed or added, prior to committing to GitHub changes that 
include adding or updating static html files.
