---
title: "Supplementary Resources -- 'A Practical Guide . . .'"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{"Supplementary Resources -- 'A Practical Guide . . .'"}
...
This website, and the associated R package, makes available code and 
other supplementary materials for a new Cambridge University Press text,
...
1. Chapter 1 gives a broad overview of the questions, approaches, and
...
2. P-values get much more critical attention than in the earlier text.
...
3. Information statistics -- primarily AIC, AICc, and BIC -- are a further
focus.  Associated relative preference measures, with a role similar
to that of Bayes Factors, are noted.  

4. There is extended commentary on the insight that studies where a
...
5. Simulation and resampling approaches get more extended use -- as
...
6. An important addition is the treatment of gene expression and other
contexts where there may be hundreds or thousands of p-values.

7. The discussion on choosing models and checking model fits has been
revised and extended.

8. The treatment of Generalized Additive Models has been rewritten and
...
decreasing response curves as specific forms of shape constrained
additive response.

9. The treatment of models that allow for extra-binomial or
extra-Poisson variation has been substantially extended.

10. Exponential time series (ETS) get greater attention, especially for
their use in forecasting.  Modeling of seasonal terms now gets
attention.

11. Changes in the lme4 package for fitting mixed-effects models, and the
...
12. Tree diagrams from tree-based regression have been finessed.  There
...
13. Principal component calculations now use the function `prcomp()`,
...
15. The treatment of causal inference from observational data has been
...
16. There is some limited attention to the use of multiple imputation to
...
17. An appendix gives a brief overview of key features of the R system
and notes technical issues that have particular relevance for users of
the text. 

18. In Chapter 2 and on, code is given only for those figures that are
...
19. The CRAN (Comprehensive R Archive Network) repository contains, at
...
Reflections, looking back on the text in its published form,
appear in "Postscript".
