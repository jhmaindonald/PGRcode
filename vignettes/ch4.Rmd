...
Additionally, Hmisc and knitr are required in order to process the Rmd source file.  The prettydoc package is by default used to format the html output.
