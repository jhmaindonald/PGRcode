...
## ----1_1, fig.width=6, fig.height=3.5, echo=F, out.width='90%'------------------------
#  ## Code
...
## ----1_2, fig.width=6, fig.height=4,  left=1.5, right=1, echo=FALSE, out.width="100%", warning=FALSE, message=FALSE----
...
## ----1_3, echo=FALSE, fig.width=6, fig.height=3.5-------------------------------------
#  ## Code
#  possum <- DAAG::possum
...
## ----1_4, fig.width=8, fig.height=5, ps=9, left=-2, bot=-1, top=1, rt=0.5, lwd=0.5, las=1, echo=FALSE, out.width="100%"----
...
## ----1_5, fig.width=8, fig.height=4, echo=FALSE, out.width="100%"---------------------
...
## ----1_6, fig.width=5, fig.height=5, ps=11, tcl=-0.25, echo=FALSE, out.width="35%"----
#  par(pty="s")
...
## ----1_7, echo=FALSE, fig.width=6, fig.height=4---------------------------------------
...
## ----1_8, fig.width=6, fig.height=2,  top=1, ps=12, out.width="100%", echo=FALSE------
...
## ----1_9, fig.width=6, fig.height=4,  bot=1, left=-2.5, top=2, rt=0.5, ps=8, mgp=c(1.5,0.25,0), fig.show='hold', out.width="72%", echo=FALSE----
...
## ----1_10, fig.width=6, fig.asp=0.25, out.width="80%", echo=FALSE---------------------
...
## ----1_11, w=7.5, h=3.0, ps=10, echo=FALSE, out.width="85%"---------------------------
...
## ----1_12, w=8, h=2.75, lwd=0.5, echo=FALSE, out.width="100%"-------------------------
#  set.seed(17)
#  x1 <- x2 <- x3 <- (11:30)/5
...
## ----1_13, w=4, h=3.6, ps=12, left=-2, mgp=c(2.0,0.5,0), tcl=-0.3, echo=FALSE---------
...
## ----1_14, w=7.2, h=1.1, left=-0.5, echo=FALSE, lwd=0.5, out.width="100%"-------------
#  mu <- 10
#  sigma <- 1
#  n <- 1
#  m <- 50
...
## ----1_15, echo=FALSE, w=7.5, h=4.2, out.width="100%"---------------------------------
...
## ----1_16, echo=FALSE, w=8, h=6.75, left=1, top=1, out.width="85%"--------------------
#  library(lattice)
...
## ----1_17, echo=FALSE, w=8, h=6.5, bot=2.5, top=1.5, las=0, xpd=TRUE, tcl=-0.3, cex.lab=0.9, echo=FALSE, ps=10, mfrow=c(2,2), out.width="90%"----
...
## ----1_18, echo=FALSE, w=8, h=3.7, top=1.5, tcl=-0.3, cex.lab=0.9, echo=FALSE, ps=9, mfrow=c(1,2), out.width="90%"----
...
## ----1_19, echo=FALSE, w=7.2, h=4.8, ps=10, out.width="80%"---------------------------
...
## ----1_20, w=7.0, h=3.0, echo=FALSE, out.width="100%"---------------------------------
#  set.seed(31)
...
## ----1_21, w=6, h=4.8, mgp=c(1.85,.5,0), echo=FALSE, out.width="60%"------------------
#  R <- pretty(0:3, 40)
...
## ----1_22, w=6.5, h=3.2, echo= FALSE, out.width="100%"--------------------------------
...
## ----1_23, echo=FALSE, w=8.0, h=3.5, bot=0.5, top=2, tcl=-0.3, cex.lab=0.9,  fig.show="hold", mfrow=c(1,2)----
...
## ----1_24, echo=FALSE, fig.width=6.5, fig.asp=0.425, fig.pos='ht', message=F, warning=F, out.width='100%'----
...
## ----1_25, echo=F, fig.width=5.5, fig.height=5, out.width="50%"-----------------------
...
#    # Set `rscale=1/sqrt(2)` (default is 1.0) as for BayesFactor; gives same BF
#    # `prior_family = "JZS"` is the default
#  # Compare with `prior_family = "JUI"`, with (if not supplied) default settings
