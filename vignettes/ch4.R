...
## ----4.1, w=3.25, h=2.4, echo=FALSE, out.width="50%"---------------------------------------------
...
## ----D2_1c, size='normalsize', results='asis'----------------------------------------------------
...
## ----4_2, w=6, h=2.0, left=-1, cex.lab=0.8, echo=FALSE, ps=9, mfrow=c(1,2), out.width="90%"------
...
## ----4_3, echo=FALSE, w=6, h=2.8, left=-1, top=2.5, lwd=0.5, cex.lab=0.9, ps=8, mgp=c(1.8, 0.5,0), out.width="100%"----
#  options(contrasts = c("contr.treatment", "contr.poly"))
#  cex.eq <- 0.85
...
## ----4_4, echo=FALSE, w=7.25, h=1.65, mgp=c(1.8,0.5,0), top=1, left=-0.5, ps=9, mfrow=c(1,4), out.width="100%"----
...
## ----4_5, w=7.2, h=3.0, left=1, lwd=0.5, tcl=-0.35, echo=FALSE, out.width="100%"-----------------
...
## ----4_6, w=7, h=2.8, left=2, rt=2, fig.pos='ht', echo=FALSE, out.width="100%"-------------------
#  ## Use ggplot2 functions to plot points, line, curve, & 95% CIs
#  ## library(ggplot2)
#  gph <- ggplot(DAAG::seedrates, aes(rate,grain)) +
...
## ----4_7, echo=FALSE, mfrow=c(1,2), mgp=c(2,0.5,0), w=6, h=2.7, left=-2.5, top=2, lwd=0.5, out.width="100%"----
#  library(mgcv)
...
## ----4_8, echo=FALSE, w=6.5, h=3.75, out.width="90%"---------------------------------------------
...
## ----4_9, w=6, h=5, mfrow=c(2,2), tcl=-0.5, left=-2, top=1, mar=c(2.5,2.5,2.1,.5), col=adjustcolor('black', 0.4), fg="gray", echo=FALSE, ps=9, out.width="100%"----
...
## ----4_10, echo=FALSE, mfrow=c(1,3), mgp=c(2,0.5,0), w=7.2, h=2.4, left=-2.0, top=1, lwd=0.5, out.width="100%", fig.pos="t"----
...
## ----4_11, echo=FALSE, warning=FALSE, w=6.5, h=3.5, bot=-1.0, left=1.5, cache=FALSE--------------
#  library(mgcv)
...
## ----4_12, echo=FALSE, w=5.5, h=2.0, left=-1, fig.pos='h', ps=9, mfrow=c(1,2), out.width="80%"----
...
## ----4_13, echo=FALSE, w=5, h=2.5, out.width="80%"-----------------------------------------------
#  library(lattice)
...
## ----D5_1c,  w=6, h=2.7, mfrow=c(1,2), out.width="100%"------------------------------------------
#  ## Fit surface
...
## ----4_14, echo=FALSE, w=6, h=1.95, bot=1, left=-1, top=1.5, fig.pos='b', ps=9, mgp=c(2,0.5,0), mfrow=c(1,3), out.width="100%"----
...
## ----4_15, echo=FALSE, w=6.5, h=3, left=-1, top=1.5, ps=10, fig.pos='b', mfrow=c(1,2), out.width="80%"----
...
## ----4_16, echo=FALSE, w=7.2, h=2.4, out.width="100%", warning=FALSE,  message=FALSE, mfrow=c(1,3)----
...
## ----D7d2, w=6, h=2.7, mfrow=c(1,2), out.width="95%"---------------------------------------------
