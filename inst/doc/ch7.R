...
## ----7_1, echo=FALSE, w=4,h=2.5, las=0, out.width="65%"------------------------------------------
...
## ----7_2, w=5.25, h=2.1, echo=FALSE, out.width="85%"---------------------------------------------
#  library(lattice)
...
## ----7_3, w=4.0, h=2.5, echo=FALSE, out.width="65%"----------------------------------------------
...
## ----7_4, w=6, h=4.4, bot=0.5, left=-1, top=0.5, ps=10, mgp=c(1.75,0.5,0), mfrow=c(2,2), echo=FALSE, out.width="100%"----
...
## ----7_5, w=6, h=4.0, mgp=c(0,.5,.5), echo=FALSE, out.width="100%"-------------------------------
#  par(mar=rep(0.25,4))
...
## ----7_6, w=6, h=2.8, lwd=1, echo=FALSE, results="hide"------------------------------------------
#  kiwishade <- DAAG::kiwishade
...
## ----7_7, w=6, h=6, echo=FALSE, out.width="100%"-------------------------------------------------
#  ## Panel A
...
## ----7_8, w=6.0, h=5.0, out.width="100%", echo=FALSE---------------------------------------------
#  library(lattice)
...
## ----G5_1e, eval=xtras, w=6, h=5, mfrow=c(2,2), out.width="100%"---------------------------------
...
## ----G6_1e, message=FALSE, warning=FALSE---------------------------------------------------------
...
## ----7_9, fig.width=8.5, fig.height=4.25, fig.show='hold', top=2, out.width="100%",  fig.align='center', message=FALSE, echo=FALSE----
...
## ----7_10, fig.width=6.5, fig.height=2.65, top=2, out.width="100%",  fig.align='center', fig.show="hold", echo=FALSE----
...
## ----7_11, fig.width=8, fig.height=8, left=-1.5, top=3.5, bot=1.5, out.width="100%", mgp=c(2.65,.5,0), fig.align='center', mfrow=c(2,2), message=FALSE, echo=FALSE----
#  par(oma=c(0,0,2,0.5))
...
## ----7_12, echo=FALSE, fig.width=5, fig.asp=0.6, warning=FALSE, fig.align='center', message=FALSE, out.width="65%", fig.show="hold"----
#  library(plotrix)
...
## ----7_13, echo=FALSE, w=4, h=4, out.width="50%"-------------------------------------------------
...
## ----7_14, echo=FALSE, w=5.5, h=3.3, cex.lab=0.9, out.width="100%"-------------------------------
...
## ----7_15, w=7.2, h=3.6, bot=1, left=-1, top=1, rt=1, ps=9, mfrow=c(1,2), mgp=c(2,0.5,0), echo=FALSE, out.width="100%"----
