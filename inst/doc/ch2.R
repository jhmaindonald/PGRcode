...
## ----2_1, echo=FALSE, w=4.5, h=2.25, left=-1, rt=1, top=1.5, mgp=c(1.5,0.5,0), ps=7, out.width="85%"----
...
## ----2_2, echo=FALSE, w=6, h=2.75, top=1, rt=2, las=0, tcl=-0.4, results='hide', ps=8, mfrow=c(1,2), out.width="85%"----
...
## ----2_3, w=9, h=6, ps=10, top=2, left=-2, bot=0.5, mfrow=c(2,3), echo=FALSE,mar=c(3.1,2.6,3.1,0.6), mgp=c(2,.5,0), out.width="100%"----
#  set.seed(29)
...
## ----2_4, w=9, h=3, ps=10, left=-2, top=2, bot=0.5, mfrow=c(1,3), echo=FALSE,mar=c(3.1,2.6,3.1,0.6), mgp=c(2,.5,0), out.width="100%"----
#  set.seed(23)
...
## ----2_5, echo=FALSE,  w=5.5, h=3.35, cex.lab=0.9,  left=-2, top=1,  rt=0.5, mgp=c(1.6,0.5,0), echo=FALSE, ps=10, mfrow=c(2,3), out.width="100%"----
...
## ----2_6, w=2.75, h=2.4, left=-1, lwd=0.75, ps=10, tcl=-0.25, lwd=0.75, echo=FALSE, fig.pos='h', out.width="42%"----
...
## ----2_7, w=7.25, h=1.65, mgp=c(1.95,0.5,0), top=1, left=-0.5, ps=10, mfrow=c(1,4), echo=FALSE, out.width="100%"----
...
## ----2_8, w=6.0, h=2.85, left=-1, top=1.5, mfrow=c(1,2), ps=10, tcl=-0.25, lwd=0.75, echo=FALSE, warning=FALSE, out.width="80%"----
...
## ----2_9, echo=FALSE, w=5, h=3, bot=2, lwd=0.75, ps=10, out.width="75%"--------------------------
...
## ----2_10, echo=FALSE, w=5.5, h=2.7, left=-1, top=1.5, cex.lab=0.75, ps=10, mfrow=c(1,2), out.width="85%"----
...
## ----2_11, w=6, h=3.6, left=-1, top=1.5, ps=10, tcl=-0.25, mfrow=c(2,3), echo=FALSE, out.width="80%"----
...
## ----2_12, w=3.25, h=2.7, top=1.25, rt=1, ps=10, tcl=-0.25, echo=FALSE, out.width="42%"----------
...
## ----2_13, w=3.0, h=2.65, echo=FALSE, out.width="42%"--------------------------------------------
...
## ----B6_2c, warning=FALSE, message=FALSE---------------------------------------------------------
...
## ----2_14, echo=FALSE, w=6, h=2.65, top=1, cex.lab=0.9, ps=10, mfrow=c(1,2), echo=FALSE, lwd=0.75, out.width="90%"----
#  set.seed(1111)
#  library(boot)
#  par(las=0)
...
## ----2_15a, w=3.5, h=2, echo=FALSE, lwd=0.5, out.width="55%", message=FALSE----------------------
...
## ----2_15b, w=9, h=3.5, ps=9, echo=FALSE, out.width="100%"---------------------------------------
...
## ----2_16, w=2.85, h=2.65, left=-1, mgp=c(2,0.5,0), echo=FALSE, out.width="42%"------------------
...
## ----2_18, echo=FALSE, w=7.5, h=3.4, left=-1, top=1.5, tcl=-0.2, cex=0.9, echo=FALSE, ps=9, out.width="100%"----
...
## ----B9_3a, message=FALSE, warning=FALSE---------------------------------------------------------
#  suppressPackageStartupMessages(library(MCMCpack))
#  roller.mcmc <- MCMCregress(depression ~ weight, data=DAAG::roller)
#  summary(roller.mcmc)

## ----2_19, w=6, h=4.0, left=-1, top=1, ps=10, tcl=-0.25, lwd=0.75, mar=c(4.1,4.1,3.1,2), mfrow=c(2,3), echo=FALSE, out.width="100%"----
...
## ----B12_11, fig.width=5, fig.height=4, out.width="40%"------------------------------------------
